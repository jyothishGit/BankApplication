...
public class AccountTest {
	...
	@Test
	public void whenValidAccountDepositAmount() throws InvalidAccountNumberException
	{
		Account account = new Account();
		account.setAccountNumber(101);
		account.setAmount(1000);
		when(accountRepository.update(account)).thenReturn(true);
		assertEquals(true, accountService.deposit(101, 1000));	
	}
	
	
	@Test(expected=com.capgemini.exceptions.InsufficientBalanceException.class)
	public void whenBalanceIsInsufficientBalance() throws InsufficientBalanceException
	{
		accountService.withdraw(101, 99);
	}
	
	@Test
	public void whenValidAmountCanWithDraw() throws InsufficientBalanceException
	{
		Account account = new Account();
		account.setAccountNumber(101);
		account.setAmount(500);
		when(accountRepository.update(account)).thenReturn(true);
		assertEquals(1, accountService.withdraw(101, 100));	
	}
